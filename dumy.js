...
class science {
    ...
    scienceFunc() {
        return 'science name is ${this.name}, his age is ${this.age}, his rollnumber is ${this.rollnumber},his subject is ${this.subject}';
    }
}
const science1 = new science("Maqadas", 15, 532845, "computer");
const science2 = new science("Fatima", 16, 530845, "Physics");
const science3 = new science("Ayesha", 17, 533645, "Biology");
let x = [];
x.push(science1);
x.push(science2);
x.push(science3);
